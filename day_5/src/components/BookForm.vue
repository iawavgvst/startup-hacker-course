        ...
        <div class="book-form-container">
            ...
            <form @submit.prevent="submitForm" class="book-form">
                <div class="form-group">
                    ...
                    <input type="text" id="title" v-model="formData.title" placeholder="Enter book title" ref="titleInput"/>
                </div>
                <div class="form-group">
...
const emit = defineEmits(['add-book', 'update:modelValue', 'close', 'cancel']);
...
// чуть-чуть сократила то, что было тут
const resetForm = () => {
    formData.value = {
        title: '',
        author: '',
